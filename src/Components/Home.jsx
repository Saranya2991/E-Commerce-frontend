...
function Home(){
    return(
        <>
        <div className="mt-20 grid grid-cols-2 bg-green-100">
            <div>
        <img src={Photo} alt="hero-img" className="h-96 p-6 ml-20" />
        </div>
        ...
        <div>
            <button className="bg-green-500 text-xl font-semibold p-2 mt-5 rounded">
